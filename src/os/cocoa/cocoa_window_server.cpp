...
palace::Window *palace::CocoaWindowServer::spawnWindow(const Window::Parameters &params) {
    ...
    cocoa_interface::WindowHandle cocoaWindow = cocoa_interface::createWindow(params.title.c_str(), params.position, params.size, params.style);
...
palace::CocoaDisplayDevice *palace::CocoaWindowServer::findDisplayDevice(const string &deviceName) const {
